...
function VennBaseLayers({ isDimmed }: { isDimmed: boolean }) {
  return (
    <>
      {/* Rellenos base */}
      <g style={{ opacity: isDimmed ? 0.15 : 0.3, transition: 'opacity 0.4s ease-out' }}>
      ...
      {/* Bordes base */}
      <g style={{ opacity: isDimmed ? 0.4 : 1, transition: 'opacity 0.4s ease-out' }} fill="none" strokeWidth="2.5">
...
function VennHitboxes({ onHover }: { onHover: (area: HoverArea) => void }) {
  return (
    <g fill="transparent" pointerEvents="all" className="cursor-pointer">
      <g onMouseEnter={() => onHover('hacking')} onMouseLeave={() => onHover(null)} mask="url(#venn-not-c2)"><g mask="url(#venn-not-c3)"><use href="#venn-c1" /></g></g>
      <g onMouseEnter={() => onHover('math')} onMouseLeave={() => onHover(null)} mask="url(#venn-not-c1)"><g mask="url(#venn-not-c3)"><use href="#venn-c2" /></g></g>
      <g onMouseEnter={() => onHover('expertise')} onMouseLeave={() => onHover(null)} mask="url(#venn-not-c1)"><g mask="url(#venn-not-c2)"><use href="#venn-c3" /></g></g>
      
      <g onMouseEnter={() => onHover('ml')} onMouseLeave={() => onHover(null)} clipPath="url(#venn-only-c2)" mask="url(#venn-not-c3)"><use href="#venn-c1" /></g>
      <g onMouseEnter={() => onHover('danger')} onMouseLeave={() => onHover(null)} clipPath="url(#venn-only-c3)" mask="url(#venn-not-c2)"><use href="#venn-c1" /></g>
      <g onMouseEnter={() => onHover('traditional')} onMouseLeave={() => onHover(null)} clipPath="url(#venn-only-c3)" mask="url(#venn-not-c1)"><use href="#venn-c2" /></g>
      
      <g onMouseEnter={() => onHover('ds')} onMouseLeave={() => onHover(null)} clipPath="url(#venn-only-c2)"><g clipPath="url(#venn-only-c3)"><use href="#venn-c1" /></g></g>
    </g>
  );
}
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center h-full">
      <div className="w-full aspect-square max-w-[520px] flex items-center justify-center">
        ...
        >
          <VennDefs />
          <VennBaseLayers isDimmed={Boolean(hovered)} />
          <VennHighlights hovered={hovered} />
          <VennLabels hovered={hovered} />
          <VennHitboxes onHover={setHovered} />
        </svg>
      </div>
